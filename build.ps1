...
Task Test -depends Build -requiredVariables TestRootDir, ModuleName, CodeCoverageEnabled, CodeCoverageFiles, ExcludeTestTags {
    ...
    try {
        ...
        if ($excludeTestTags) {
            $testing.ExcludeTag = $excludeTestTags
        }
